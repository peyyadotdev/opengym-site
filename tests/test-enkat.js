...
(async () => {
  ...
  // ---------- Flöde A: hela enkäten på desktop ----------
  {
    ...
    await page.check('input[name="q17_betalsatt"][value="Autogiro"]');
    ...
    check('q17b har bara de valda betalsätten', q17bOpts.join('|') === 'Autogiro|Swish');
    ...
    check('q17c har de valda betalsätten plus Annat sätt', q17cOpts.join('|') === 'Autogiro|Swish|Annat sätt');
    ...
    await page.check('input[name="q17c_medlemskap"][value="Autogiro"]');
    ...
    check('betalsätt per sak med i svaren', a.q17c_medlemskap === 'Autogiro' && a.q17d_dropin === 'Säljer vi inte' && a.q17e_pt === 'Säljer vi inte' && a.q17f_butik === 'Swish' && a.q17g_kanal === 'På plats i boxen');
